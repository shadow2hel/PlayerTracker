...
//        );
        return new PlayerData.Builder(rs.getString(1), PlayerUtils.getPlayerUsername(rs.getString(1)))
                ...
                .withPlaytimeAll(new MinecraftTime(rs.getString(3)))
                .withPlaytimeThisWeek(new MinecraftTime(rs.getString(4)))
                .withPlaytimeThisMonth(new MinecraftTime(rs.getString(5)))
                .withPlaytimeThisYear(new MinecraftTime(rs.getString(6)))
